...
const Projects = () => {
  return (
    <SectionWrapper id="projects">
      ...
      <div className="mt-20 flex flex-wrap items-stretch justify-start gap-10">
        {projects.map((project, index) => (
          <Link key={index} href={project.url}>
            ...
            >
              <header className="flex items-center justify-between p-3 xs:p-4 sm:gap-3 sm:p-5">
              ...
              <div className="">
                ...
                <p className="p-3 text-xs text-gray-400 xs:p-4 sm:gap-3 sm:p-5 md:text-base">
                  {project.desc}
                </p>
              </div>
            </motion.main>
